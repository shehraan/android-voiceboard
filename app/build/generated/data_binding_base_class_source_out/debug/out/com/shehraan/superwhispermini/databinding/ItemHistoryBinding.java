...
public final class ItemHistoryBinding implements ViewBinding {
  ...
  private ItemHistoryBinding(@NonNull LinearLayout rootView, @NonNull Button copyButton,
      @NonNull Button deleteButton, @NonNull TextView finalText, @NonNull TextView metaText) {
  ...
  public static ItemHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.finalText;
      TextView finalText = ViewBindings.findChildViewById(rootView, id);
      if (finalText == null) {
        break missingId;
      }
      ...
      return new ItemHistoryBinding((LinearLayout) rootView, copyButton, deleteButton, finalText,
          metaText);
    }
